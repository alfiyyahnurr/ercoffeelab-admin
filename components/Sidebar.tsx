      ...
      >
          ...
          {collapsed ? (
            ...
            <div className="flex items-center gap-3 overflow-hidden w-full">
              ...
              <button
                type="button"
                onClick={onToggleCollapse}
                className="w-6 h-6 rounded-md text-[#8B93B8] hover:text-[#C9A876] hover:bg-[#181F4B] flex items-center justify-center transition-colors cursor-pointer shrink-0"
        ...
        <div className="p-2.5 border-t border-[#232B66]/60 bg-[#0A0D24] shrink-0 space-y-1.5">
          {!collapsed && staff && (
            <Link
              href="/profile"
              className="flex items-center gap-2.5 px-2 py-1.5 rounded-lg bg-[#181F4B]/40 hover:bg-[#181F4B] border border-[#232B66]/40 hover:border-[#C9A876]/40 transition group cursor-pointer"
              title="Lihat Profil Saya"
            >
              <div className="w-7 h-7 rounded-full bg-[#181F4B] border border-[#C9A876]/30 flex items-center justify-center shrink-0 text-[#C9A876] group-hover:scale-105 transition">
                <User className="w-3.5 h-3.5" />
              </div>
              <div className="overflow-hidden flex-1">
                <p className="text-[11.5px] font-bold text-white font-albert truncate leading-tight group-hover:text-[#C9A876] transition">
                  {staff.fullName}
                </p>
                <p className="text-[10px] text-[#8B93B8] truncate font-medium mt-0.5 leading-tight">
